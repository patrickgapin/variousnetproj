...
namespace MovieStreaming.Common.Actors
{
    ...
    public class PlaybackActor : ReceiveActor
    {
        ...
        public PlaybackActor()
        {
            ...
            Context.ActorOf(Props.Create<UserCoordinatorActor>(), Constants.ActorsNames.UserCoordinator);
            Context.ActorOf(Props.Create<PlaybackStatisticsActor>(), Constants.ActorsNames.PlaybackStatistics);
